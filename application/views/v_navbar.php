	...
	<nav class="navbar navbar-dark" style="height: 30px; background-color: #000000">
		...
		<nav class="navbar navbar-dark navbar-expand-lg navbar-expand-md" style="background-color: #000000">
			...
			<form class="form-inline d-inline d-sm-inline d-md-none"  method="post" action="<?php echo base_url('search');?>">
				<input class="form-control" type="text" placeholder="Search" size="13" name="search">
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="d-none d-sm-none d-md-block">
						<form class="form-inline my-2 my-lg-0"  method="post" action="<?php echo base_url('search');?>">
							<input class="form-control mr-sm-2" type="text" placeholder="Search" size="25" name="search">
