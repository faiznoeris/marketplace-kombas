		...
		<tbody>
			...
			<?php foreach ($this->cart->contents() as $items): ?>
				...
				<tr>
					...
					<td>	
						<div class="quantity">
							<input type="number" id="qty" min="1" max="100" step="1" value="<?= $items['qty'] ?>" disabled>
...
<!-- 			<tr>
				...
				<td>1</td>
				<td>Rp. 300.000</td>
				<td><a href="" class="btn btn-danger btn-sm"><span class="oi oi-delete"></span></a></td>
			</tr>
			<tr>
				<th scope="row">3</th>
				<td><img src="https://id-live-03.slatic.net/p/7/distro-bandung-vr-355-sepatu-kets-sneakers-dan-kasual-pria-hitam-1487054474-20960041-d5ab29e5322276e9da877a49cd42cc3c.jpg" width="130" height="130"></td>
			...
			<tr>
				...
				<td colspan="2"><b>Rp. 1.800.000</b></td>
			</tr>
		</tbody>
	</table>
