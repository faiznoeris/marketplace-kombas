			...
			<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner product" role="listbox">
					<div class="carousel-item active">
						...
						<div class="tile first-slide d-block img-responsive" data-scale="2.4" data-image="http://st.motortrend.com/uploads/sites/5/2017/03/2017-Toyota-86-860-Special-Edition-rear-three-quarter-in-motion.jpg"></div>
					</div>
					<div class="carousel-item">
						<!-- <img class="d-block h-100 w-100" src="#" data-src="holder.js/900x400?theme=industrial" alt="Second slide"> -->
						<div class="tile first-slide d-block img-responsive" data-scale="2.4" data-image="https://secure-akns.subaru.com/content/media/mp_hero_880/18_CTK_photos_ext_15.jpg"></div>
					</div>
				</div>
