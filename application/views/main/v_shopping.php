					...
					<?php if(!empty($prods)): ?>
						...
						<?php foreach ($prods as $items): ?>
							...
							// $data_bintang5 	= 	$this->M_Index->data_productview_getreview_bintang("lima", $items->id_product)->row()->bintang_lima;
								...
								$totalreview = $totalreview_shopping[$items->id_product];

								$data_bintang1 = $data_bintang1_shopping[$items->id_product];
								$data_bintang2 = $data_bintang2_shopping[$items->id_product];
								$data_bintang3 = $data_bintang3_shopping[$items->id_product];
								$data_bintang4 = $data_bintang4_shopping[$items->id_product];
								$data_bintang5 = $data_bintang5_shopping[$items->id_product];
