	...
	<div class="page-header">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Konfirmasi Pengiriman Barang</span></h4>
			</div>
		...
		<div class="breadcrumb-line breadcrumb-line-component">
			<ul class="breadcrumb">
				...
				<li class="active">Konfirmasi Pengiriman Barang</li>
			</ul>
		</div>
	</div>
	<!-- /page header -->
	...
	<div class="content">
		...
		<div class="panel panel-flat">
			<div class="panel-heading">
				<h5 class="panel-title">Konfirmasi Pengiriman Barang</h5>
			</div>

			<div class="panel-body">
				<form class="form-horizontal" method="post" action="<?php echo base_url('Pembelian/barangdikirim/'.$this->uri->segment(4));?>">


					<div class="form-group">
						<label class="control-label col-lg-2">Masukkan resi pengiriman</label>
						<div class="col-lg-10">
