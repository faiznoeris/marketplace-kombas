										...
										<li class="dropdown">
											...
											<ul class="dropdown-menu dropdown-menu-right">
												...
												<?php if($row->status == "On Delivery"):?>
													<li><a data-toggle="modal" data-target="#modal_updateresi_<?= $row->id_transaction ?>"><i class="icon-checkmark3"></i> Update Resi</a></li>
												<?php else: ?>
													<li class="disabled"><a href="<?= base_url('dashboard/toko/editresi/'.$row->id_transaction) ?>"> Update Resi</a></li>
												<?php endif; ?>
								...
								<div id="modal_brgdikirim_<?= $row->id_transaction ?>" class="modal fade">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<form method="post" action="<?php echo base_url('Seller/barangdikirim/'.$row->id_transaction);?>">
								...
								<div id="modal_updateresi_<?= $row->id_transaction ?>" class="modal fade">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<form method="post" action="<?php echo base_url('Seller/updateresi/'.$row->id_transaction);?>">
												...
												<li class="dropdown">
													...
													<ul class="dropdown-menu dropdown-menu-right">
														...
														<?php if($row->status == "Pending"):?>
															<li><a data-toggle="modal" data-target="#modal_brgdikirim_<?= $row->id_transaction ?>") ?> Barang Dikirim</a></li>
														<?php else: ?>
															<li class="disabled"><a><i class="icon-checkmark3"></i> Barang Dikirim</a></li>
														<?php endif; ?>
