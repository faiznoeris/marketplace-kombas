	...
	<div class="content">
		...
		<div class="panel panel-flat">
			...
			<div class="panel-body">
				<form class="form-horizontal" method="post" action="<?php echo base_url('Admins/addproduct/');?>" enctype='multipart/form-data'>
					<fieldset class="content-group">
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control" maxlength="12" placeholder="Masukkan nama product" name="nama_product">
							</div>
						</div>
						...
						<div class="form-group">
							<label class="control-label col-md-2">Diskon Dropshipper</label>
							<div class="col-md-10">
								<input class="form-control" type="number" placeholder="Masukkan diskon dropshipper" name="disc_dropshipper">
							</div>
						</div>
						...
						<div class="form-group">
							<label class="control-label col-md-2">Berat Product (KG)</label>
							<div class="col-md-10">
