	...
	<div class="page-header">
		<div class="page-header-content">
			<div class="page-title">
				<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Add New Category</span></h4>
			</div>
		...
		<div class="breadcrumb-line breadcrumb-line-component">
			<ul class="breadcrumb">
				...
				<li class="active"><a href="<?= base_url('dashboard/listcategory') ?>">Daftar Category</a></li>
	...
	<div class="content">
		...
		<div class="panel panel-flat">
			<div class="panel-heading">
				<h5 class="panel-title">Menambahkan Category Baru</h5>
			</div>

			<div class="panel-body">
				<form class="form-horizontal" method="post" action="<?php echo base_url('Admins/addcategory/');?>" enctype='multipart/form-data'>
					<fieldset class="content-group">
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control" maxlength="12" placeholder="Masukkan nama category" name="nama_category">
							</div>
						</div>
